...
import com.lms.lmsapi.config.AppConfig;
...
import com.lms.lmsapi.entity.dto.user.*;
...
import static com.lms.lmsapi.constants.FileConstants.STATIC_REQUEST_PREFIX;
import static com.lms.lmsapi.constants.UserConstants.*;
...
//        User byId = this.getById(id);  根据用户id查找用户
    ...
    public String uploadAvatar(MultipartFile file, Long uid) {
        ...
        String fileUrl = com.lms.lmsapi.utils.FileUtil.getFileUrl(ossProperties.getEndpoint(), STATIC_REQUEST_PREFIX, bucketName, filePath);
